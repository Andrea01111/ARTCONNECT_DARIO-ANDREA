...
public class DbCommunityService implements CommunityService {
    ...
    // Le constructeur demande le DAO des membres
    ...
    public List<Review> getReviewsByMember(CommunityMember member) {
        // Lors de la normalisation de la base de données (Étape 2), 
        // le système de 'Review' a été optimisé en système de 'Like'.
        // Pour ne pas casser l'ancienne interface Java, on retourne une liste vide.
